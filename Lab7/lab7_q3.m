...
trapezoid_method(a,b,f,h,alpha,actual_y,6);
...
trapezoid_method(a,b,f,h,alpha,actual_y,9);

%lambda = -10, h = 0.001
h = 0.001;
explicit_euler(a,b,f,h,alpha,actual_y,10);
implicit_euler(a,b,f,h,alpha,actual_y,11);
trapezoid_method(a,b,f,h,alpha,actual_y,12);
...
trapezoid_method(a,b,f,h,alpha,actual_y,18);
